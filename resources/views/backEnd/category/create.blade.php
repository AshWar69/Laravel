...
<div id="breadcrumb"> <a href="{{ url('/admin') }}" title="Go to Home" class="tip-bottom"><i
            class="icon-home"></i> Home</a> <a href="{{ route('category.index') }}">Categories</a> <a
        href="{{ route('category.create') }}" class="current">Add New Category</a> </div>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="{{ route('category.store') }}"
                        ...
                        <div
                            class="control-group{{ $errors->has('name')?' has-error':'' }}">
                ...
                <div
                    class="control-group{{ $errors->has('status')?' has-error':'' }}">
